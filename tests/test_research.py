...
class TestBraveSearch:
    """brave_search is a legacy alias that now delegates to web_search
    (DuckDuckGo); the old Brave API key path was removed."""
    ...
    def test_successful_search_delegates(self, mock_search):
